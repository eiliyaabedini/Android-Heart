...
class KoinModulesTest : KoinTest {
    ...
    fun setUp() {
        ...
        declareMock<FirebaseDynamicLinks>()
    }
    ...
    @Test
    fun testHeartDeeplinkModule() {
        testInjection<DeeplinkDispatcher>(false)
        testInjection<FirebaseDeeplinkFetcher>(false)
        testScopedInjection<LinkDispatcherActivity, Presenter<LinkDispatcherActivityPresenter.View>>()
    }
